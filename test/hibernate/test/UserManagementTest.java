...
public class UserManagementTest {
	...
	public void testUserCreation() {
		um.createUser("John", "First", "johnfirst@gmail.com", "In the vicinity", "numero uno", null);
		um.createUser("Bob", "Second", "bob.second@outlook.com", "Not far away", "numero dos", null);
		um.createUser("Phil", "Last", "phil@last.com", "Here", "nomero tres", null);
