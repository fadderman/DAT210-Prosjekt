	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner shadow">
			<div class="container">
				...
				<!-- NAVIGATION -->
				<ul class="nav">
					<li class="${activeMenuItem.home}"><a href="home"><i
							class="icon-home"></i> <%= language.getMenu_home() %></a></li>
					<li class="${activeMenuItem.find} dropdown"><a
						class="dropdown-toggle" data-toggle="dropdown" href="#"><i
							class="icon-search"></i> <%=language.getMenu_find() %> <b
							class="caret"></b></i> </a>
					...
					<li class="${activeMenuItem.profile}"><a href="profile"><i
							class="icon-user"></i> <%= language.getMenu_profile() %></a></li>
					<li class="${activeMenuItem.settings}"><a href="settings"><i
							class="icon-cog"></i> <%= language.getMenu_settings() %></a></li>
						...
						<form action="search" method="get" class="navbar-form form-search">
							<div class="input-append">
								<input class="search-query span2" type="text" name="query"
									id="search" placeholder="<%= language.getMenu_search() %>..." />
