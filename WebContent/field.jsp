...
<div class="container well" style="box-shadow: 5px 5px 8px -1px #222;">
	...
	<c:choose>
		<c:when test="${nullField eq true}">
			<div class="alert alert-error">Given field does not exist or
				the given argument is invalid. Please try again.</div>
		</c:when>
		<c:otherwise>
			<div class="row-fluid">
				<div class="span12">
					<i class="icon-book"></i>
					<legend>Field: ${field.title}</legend>
				</div>
			</div>
			...
			<div class="row-fluid">
				<div class="span3">
					...
					<legend>Find in ${field.title}</legend>
				</div>
			</div>
...
<<<<<<< HEAD
						<div class="span6" align="center">
							<a class="btn btn-primary" type="submit" href="">Mentor</a>
						</div>
						<div class="span6" align="center">
							<a class="btn btn-primary" type="submit" href="">Trainee</a>
						</div>
=======
